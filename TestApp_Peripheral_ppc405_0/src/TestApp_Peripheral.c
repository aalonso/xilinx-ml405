...
int main (void) {
   ...
   static XGpio Push_Buttons_Position_Gpio;
   static XLlTemac TriMode_MAC_GMII_LlTemac;
   static XLlDma  TriMode_MAC_GMII_LlDma;
...

   {
      ...
      status = GpioInputExample(XPAR_PUSH_BUTTONS_POSITION_DEVICE_ID, &DataRead);
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &Push_Buttons_Position_Gpio, \
   ...
   /* TemacPolledExample does not support SGDMA      
   {
      ...
      status = TemacPolledExample( XPAR_TRIMODE_MAC_GMII_CHAN_0_DEVICE_ID,
                                   );
   ...
   */

   {
      ...
      print("\r\nRunning TemacSgDmaIntrExample() for TriMode_MAC_GMII...\r\n");

      Status = TemacSgDmaIntrExample(&intc, &TriMode_MAC_GMII_LlTemac,
                     &TriMode_MAC_GMII_LlDma,
                     XPAR_TRIMODE_MAC_GMII_CHAN_0_DEVICE_ID,
